        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8">
          ...
          >
            ...
            <h2 className="text-6xl sm:text-7xl lg:text-8xl font-black mb-8 tracking-tighter leading-tight relative z-10">
              Blazing Fast <span className="gradient-text glow-text">Compute</span>.
            </h2>
            <p className="text-text-secondary text-xl sm:text-2xl max-w-2xl mx-auto leading-relaxed font-light relative z-10">
              High-performance virtual private servers with NVMe storage. Total control for your applications.
            </p>
          </motion.div>
          ...
          <div>
            ...
            <div className="mt-12 text-center">
              ...
              >
                ...
                Need a tailored high-capacity VPS? Contact us on Discord for a custom plan!
              </a>
            </div>
          </div>
        </div>
